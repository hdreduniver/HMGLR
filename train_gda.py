...
from prepro import read_convert_cdr, read_convert_gda
                ...
                if (step + 1) == len(train_dataloader) - 1 or (args.evaluation_steps > 0 and num_steps % args.evaluation_steps == 0 and step % args.gradient_accumulation_steps == 0):
                    ...
                    if dev_score > best_score:
                        ...
                        if args.save_path != "":
                            ...
                            with open('./saved_model/gda/log.txt', 'a') as f:
...
def main():
    ...
    parser.add_argument("--save_path", default="./saved_model/gda/best.model", type=str)
    ...
    read = read_convert_cdr if "cdr" in args.data_dir else read_convert_gda
